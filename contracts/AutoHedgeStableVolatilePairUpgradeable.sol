...
*/
contract AutoHedgeStableVolatilePairUpgradeableV2 is IDeltaNeutralStableVolatilePairUpgradeable, Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable, UniswapV2ERC20Upgradeable {
    ...
    // Deposit $100 DAI
    // Flashloan for $100 of ETH
    // addLiquidity
    // Add DEX LP to collateral
    // Borrow $100 of ETH and repay flashloan


    // Rebalance borrow more, 0.1 ETH diff, price of ETH $1000
    // Borrow 0.2 ETH, swap 0.1 ETH for 100 DAI, LP with them

    // Rebalance repay, 0.1 ETH diff, price of ETH $1000
    // Maybe need to take out a flashloan?
    // Withdraw $200 of underlying assets, convert the DAI to ETH, repay 0.2 ETH
